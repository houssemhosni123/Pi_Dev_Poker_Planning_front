...
public interface ReclamationRepositories extends JpaRepository <Reclamation,Long> {
    ...
    @Query("SELECT COUNT(r) FROM Reclamation r WHERE r.userReclamer.Nom = ?1 AND r.userReclamer.Prenom = ?2")
    Long countReclamationsByUserNomAndPrenom(String nom, String prenom);

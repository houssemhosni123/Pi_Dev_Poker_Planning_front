...
import { ProjeteyaService } from 'app/Services/gestionProjetServices/ProjeteyaServices';
...
export class ModfierProjetComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private router: Router, private projetService: ProjeteyaService) { }
